...
// SatelliteDeliverySystem keeps Frequency (GHz), OrbitalPosition (degrees)
// and SymbolRate as raw BCD digits; RollOff applies only when
// ModulationSystem (DVB-S2) is set.
